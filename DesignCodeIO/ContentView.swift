...
struct ContentView : View {
    ...
    var body: some View {
        ZStack {
            ...
            CardView()
                .background(show ? .red : Color("background9"))
                .cornerRadius(10)
                .shadow(radius: 20)
                .offset(x: 0, y: show ? -400 : -40)
                .scaleEffect(0.85)
                .rotationEffect(Angle(degrees: show ? 15 : 0))
                //                .rotation3DEffect(Angle(degrees: show ? 50 : 0), axis: (x: 1, y: 1, z: 1))
            ...
            CardView()
                ...
                //                .rotation3DEffect(Angle(degrees: show ? 40 : 0), axis: (x: 1, y: 1, z: 1))
            ...
            CertificateView()
                ...
                //                .rotation3DEffect(Angle(degrees: show ? 30 : 0), axis: (x: 1, y: 1, z: 1))
    ...
    var body: some View {
        return VStack(spacing: 20.0) {
            Rectangle()
                ...
                .cornerRadius(3)
                .opacity(0.1)
            Text("This certificaste is proof that Daniel has achieved the UI Design course with approval from a Design+Code instructor.")
                .lineLimit(10)
            Spacer()
        }
