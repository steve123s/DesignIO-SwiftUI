...
//  01
//
//  Created by Daniel E. Salinas on 2020/4/3.
...
//                .rotation3DEffect(Angle(degrees: showCard ? 0 : 5), axis: (x: 10, y: 0, z: 0))
            ...
            CardView()
                .frame(maxWidth: self.showCard ? 375 : 340)
                .frame(height: 220)
    ...
    var body: some View {
        VStack(spacing: 20) {
            Rectangle()
                ...
                .cornerRadius(3)
                .opacity(0.1)
            Text("Lorem ipsum dolor sit amet, consectetur adipiscaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum")
